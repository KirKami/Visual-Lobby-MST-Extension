...
{
    public class AdditiveLevelsRoomClient : RoomClient<AdditiveLevelsRoomClient>
    {
        #region INSPECTOR
        ...
        /// </summary>
        protected AdditiveLevelsRoomNetworkManager networkManager => NetworkManager.singleton as AdditiveLevelsRoomNetworkManager;
        ...
        protected override void Start()
        {
            ...
            {
                logger.Error($"Before using {typeof(AdditiveLevelsRoomNetworkManager).Name} add it to scene");
            }
        }
        ...
        protected virtual void ValidateRoomAccessResultHandler(ValidateRoomAccessResultMessage msg)
        {
            ...
            LoadOnlineScene();
            networkManager.onlineScene = "QUEST_STARTER";
        }
