...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class MstMatchmakerClient : MstBaseClient
    {
        ...
        #region BF_MODIFIED
        /// <summary>
        /// Current Region of Client
        /// </summary>
        public RegionInfo Region { get; private set; }
        public GameInfoPacket RegionLobby { get; private set; }
        #endregion
        ...
        #region BF_MODIFIED
        public void SetClientRegion(RegionInfo region)
        {
            Region = region;
            ...
            MstTimer.WaitForSeconds(0.1f, () =>
            {
                ...
                searchOptions.Add(Mst.Args.Names.RoomRegion, Region.Name);
                //searchOptions.Add(Mst.Args.Names.RoomType, 2);
                ...
                Mst.Client.Matchmaker.FindGames(searchOptions, (games) =>
                {
                    ...
                    RegionLobby = games[0];
                    Logs.Debug("Region Lobby: " + RegionLobby.Name);

                    //Uncomment for automatic connection to lobby after selecting region
                    //if (RegionLobby != null) MasterServerToolkit.Bridges.MatchmakingBehaviour.Instance.StartMatch(RegionLobby);
                });
            });
        }
        #endregion
