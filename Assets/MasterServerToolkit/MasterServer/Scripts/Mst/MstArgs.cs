...
namespace MasterServerToolkit.MasterServer
{
    public class MstArgs
    {
        ...
        /// <summary>
        /// Path to the lobby executable (used by the spawner)
        /// </summary>
        public string LobbyExecutablePath { get; private set; }
        #endregion
        ...
        public MstArgs()
        {
            ...
            #region BF_MODIFIED
            RoomType = (ushort)AsInt(Names.RoomType, 0);

            LobbyExecutablePath = AsString(Names.LobbyExecutablePath);
            #endregion
